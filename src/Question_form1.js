...
function Question_form() {
  ...
  function commitToDB({ documentName, documentDescription, questions, id }) {
    dispatch({
      type: actionTypes.SET_QUESTIONS,
      questions: questions,
    });
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.success) {
          ...
          console.error("Failed to save form data:", response.data.message);
        }
      })
      .catch((error) => {
  ...
  function addQuestionType(i, type) {
    ...
    updatedQuestions[i].questionType = type;
